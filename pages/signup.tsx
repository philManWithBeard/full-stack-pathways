...
const schema = yup
  .object({
    ...
    mobileNumber: yup
      ...
      .integer("Full stops are not allowed"),
  ...
  return (
    <Layout>
      <div className={styles.signupFlex}>
        <section className={styles.studentDetails}>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className={styles.signupDiv}>
              ...
              <p className={styles.signupError}>{errors.surname?.message}</p>
            </div>
            <div className={styles.signupDiv}>
              <label className={styles.label}>Mobile Number</label>
              <input className={styles.input} {...register("mobileNumber")} />
        ...
        <section className={styles.shoppingCart}></section>
      </div>
    </Layout>
  );
}
...
const genderList = [
  { name: "Female", key: 0 },
  { name: "Male", key: 1 },
  { name: "Non-binary", key: 2 },
  { name: "Transgender", key: 3 },
  { name: "Intersex", key: 4 },
  { name: "Let me type", key: 5 },
  { name: "I'd prefer not to say", key: 6 },
];
const countryList = [
